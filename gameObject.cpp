...
GameObject::GameObject(std::shared_ptr<Mesh> target, std::shared_ptr<Material> material)
...
{
    // Update animation before drawing (deltaTime should come from your frame timer)
    UpdateAnimation(0.016f); // For example, 16ms per frame (~60fps)
